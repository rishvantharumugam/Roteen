...
async function run() {
  const s = await supabase.from('subjects').select('*').eq('id', '68312691-bcaf-4138-9a39-8e8f97b9f2a2');
  const c = await supabase.from('chapters').select('*').eq('id', '4ca74226-97d6-479e-a19d-fe9ec05fa147');
  console.log('Subject:', s.data);
  console.log('Chapter:', c.data);
}
