...
export function TutorialPage({
  ...
  return (
    <div className="bg-black text-zinc-200 min-h-screen relative flex flex-col lg:h-screen lg:overflow-hidden text-slate-100">
      ...
      <TutorialHeaderStore />
      <main className="relative min-h-0 flex-1 min-w-0 overflow-y-auto lg:overflow-hidden px-4 py-4 sm:px-6 lg:px-8">
        <div className="mx-auto grid w-full max-w-[1540px] grid-cols-1 lg:grid-rows-[auto_minmax(0,1fr)] lg:h-full gap-4">
          <TutorialHeroSection pageData={pageData} />
          <div className="grid min-h-0 gap-4 grid-cols-1 lg:grid-cols-[20rem_minmax(0,1fr)]">
            <TutorialSidebar
