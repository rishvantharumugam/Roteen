...
export function EmptyNotification({
  ...
  return (
    <div className={`group relative overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#101114] p-5 transition duration-300 hover:border-[#7C3AED]/30 py-8 text-center sm:py-9`}>
