...
import type { UserPlaylist } from "@/features/video/services/videoBookmarkService";
  ...
  return (
    <AnimatePresence>
      {isOpen ? (
        ...
        >
          <motion.div
            className="w-full max-w-[520px] overflow-hidden rounded-[24px] border border-zinc-800 bg-[#121212] shadow-[0_20px_60px_rgba(0,0,0,0.8)] flex flex-col max-h-[calc(100vh-40px)]"
