export const sessionStyles = {
  ...
  activeCardsGrid:
    "mt-5 grid justify-start gap-5 [grid-template-columns:repeat(auto-fill,minmax(280px,280px))] max-[700px]:[grid-template-columns:repeat(1,minmax(0,1fr))] min-[701px]:max-[1100px]:[grid-template-columns:repeat(2,minmax(280px,1fr))]",
  emptyState:
    "rounded-lg border border-white/10 bg-[#0e1226] p-5 text-sm text-slate-400 lg:col-span-2",

  sessionCard:
    "group flex h-full min-h-[390px] flex-col overflow-hidden rounded-[20px] border border-white/10 bg-[linear-gradient(165deg,rgba(15,18,40,.9)_0%,rgba(8,10,24,.92)_100%)] p-4 shadow-[0_10px_35px_rgba(124,58,237,0.18)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:border-violet-300/45 hover:shadow-[0_18px_48px_rgba(124,58,237,.34)]",
