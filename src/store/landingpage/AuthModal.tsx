...
export function AuthModal({
  ...
  const inputClassName =
    "mt-1.5 w-full rounded-2xl border border-slate-200/80 bg-white/88 px-4 py-3 text-sm text-slate-800 shadow-[inset_0_1px_1px_rgba(255,255,255,0.65)] outline-none transition placeholder:text-slate-400 focus:border-cyan-300 focus:bg-white focus:ring-4 focus:ring-cyan-100";
  const otpInputClassName =
    "mt-1.5 w-full rounded-2xl border border-slate-200/80 bg-white/88 px-4 py-3 text-center text-sm tracking-[0.35em] text-slate-800 shadow-[inset_0_1px_1px_rgba(255,255,255,0.65)] outline-none transition placeholder:tracking-normal focus:border-cyan-300 focus:bg-white focus:ring-4 focus:ring-cyan-100";
  const selectClassName =
    "mt-1.5 w-full rounded-2xl border border-slate-200/80 bg-white/88 px-4 py-3 text-sm text-slate-800 outline-none transition focus:border-cyan-300 focus:bg-white focus:ring-4 focus:ring-cyan-100";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden px-2 py-3 sm:px-4 sm:py-6">
      ...
      />
      <div aria-hidden="true" className="pointer-events-none absolute -left-28 top-20 h-72 w-72 rounded-full bg-cyan-300/25 blur-[110px]" />
        ...
        {isSignIn ? (
          <form className="space-y-4 px-5 py-5" onSubmit={handleSignIn}>
            {signInStep === 1 ? (
              ...
              <>
                <div className="rounded-3xl border border-cyan-100 bg-[linear-gradient(180deg,rgba(240,249,255,0.95)_0%,rgba(255,255,255,0.98)_100%)] px-4 py-4 text-center">
                  <MailVerifyArtwork />
            ...
            {signInStep === 2 ? (
              <>
                ...
                <button
                  ...
                  className="w-full rounded-2xl border border-cyan-200 bg-cyan-50/70 px-5 py-3 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-50"
                >
                  Resend OTP
                </button>
              </>
          ...
          <form className="no-scrollbar min-h-0 overflow-y-auto space-y-3 px-4 py-3.5 sm:px-4.5" onSubmit={handleSignUp}>
            {signUpStep === 1 ? (
              ...
              <>
                <label className="block text-sm font-medium text-slate-600">
                  Phone Number
                  <div className="mt-1.5 flex rounded-2xl border border-slate-200/80 bg-white/88 transition focus-within:border-cyan-300 focus-within:bg-white focus-within:ring-4 focus-within:ring-cyan-100">
            ...
            {signUpStep === 2 ? (
              <button
                ...
                className="w-full rounded-2xl border border-cyan-200 bg-cyan-50/70 px-5 py-2.5 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-50"
              >
                Resend OTP
              </button>
            ) : null}
            ...
            {signUpStep === 1 ? (
              <>
                ...
                <button
                  ...
                  disabled={isSubmitting || isGoogleSubmitting}
                  className="flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-[0_8px_20px_rgba(15,23,42,0.06)] transition hover:border-cyan-200 hover:bg-cyan-50/45 disabled:cursor-not-allowed disabled:text-slate-400"
                >
                  <GoogleIcon />
