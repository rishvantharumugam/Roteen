...
export const ExploreCourseCard = memo(function ExploreCourseCard({
  ...
  return (
    <article
      ...
      className="group relative flex aspect-[4/3] w-[300px] flex-shrink-0 cursor-pointer snap-start flex-col overflow-hidden rounded-2xl border border-white/5 bg-slate-950 p-6 shadow-xl transition-transform hover:-translate-y-1 hover:border-purple-500/30 hover:shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/60 sm:w-[320px]"
      style={{
