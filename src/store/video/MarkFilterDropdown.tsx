  ...
  return (
    <div className="relative z-50" ref={containerRef}>
      ...
      >
        ...
        <div className="absolute inset-0 -z-10 rounded-xl bg-gradient-to-r from-purple-500/0 via-purple-500/0 to-purple-500/0 transition-all duration-300 group-hover:from-purple-500/10 group-hover:to-blue-500/10" />
      </motion.button>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 rounded-2xl border border-transparent bg-gradient-to-br from-purple-500/30 to-blue-500/30 [mask-composite:exclude] [mask-image:linear-gradient(#fff_0_0),linear-gradient(#fff_0_0)]" style={{ WebkitMaskClip: "content-box, border-box" }} />
                  ...
                  >
                    ...
                    {isSelected && (
                      <motion.div
                        ...
                        className="absolute inset-0 -z-10 rounded-xl bg-gradient-to-r from-purple-600/80 to-blue-600/80 shadow-[0_0_15px_rgba(124,58,237,0.5)]"
                        initial={false}
