...
import type { QuestionMode } from "@/service/video";
          ...
          >
            {isActive && (
              <motion.div
                ...
                className="absolute inset-0 z-0 overflow-hidden rounded-full bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500 shadow-[0_0_24px_rgba(124,58,237,0.45),inset_0_1px_1px_rgba(255,255,255,0.3)]"
                initial={false}
                transition={{
                  type: "spring",
                  stiffness: 450,
