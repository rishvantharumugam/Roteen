...
export default function PlaylistSidebar({
    ...
    const loadQuestions = async () => {
      ...
      try {
        ...
        (data ?? []).forEach((row) => {
          ...
          const questionTitle = typeof row.question_name === "string" ? row.question_name.trim() : "";
  ...
  if (loading) {
    return (
      <div className={`${videoStyles.style_10bb6f80e7bd7e} rounded-2xl border border-zinc-800/90 bg-[radial-gradient(circle_at_10%_7%,rgba(62,43,138,0.22),rgba(8,12,24,0.96)_42%),linear-gradient(160deg,#050915,#040710)] p-2.5 shadow-[0_18px_36px_rgba(0,0,0,0.42)]`}>
  ...
  return (
    <aside className={`${videoStyles.style_10bb6f80e7bd7e} rounded-2xl border border-zinc-800/90 bg-[radial-gradient(circle_at_10%_7%,rgba(62,43,138,0.22),rgba(8,12,24,0.96)_42%),linear-gradient(160deg,#050915,#040710)] p-2.5 shadow-[0_18px_36px_rgba(0,0,0,0.42)]`}>
