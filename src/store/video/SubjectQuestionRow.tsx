...
export default function SubjectQuestionRow({
  topicId,
  title,
  active,
  completed,
  ...
  return (
    <motion.button
      ...
      whileHover={{ x: 5 }}
      whileTap={{ scale: 0.98 }}
      className={`group relative flex w-full items-center justify-between overflow-hidden rounded-lg px-2 py-1.5 text-left transition-all duration-300`}
    >
      ...
      {completed ? (
        <div className="relative z-10 flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-purple-500 text-purple-500 shadow-[0_0_8px_rgba(168,85,247,0.4)]">
